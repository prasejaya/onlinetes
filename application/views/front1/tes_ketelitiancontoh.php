    ...
    <div class="container">
        <div class="col-md-12">
            <ul class="breadcrumb">
                ...
                <li>Ketelitian Contoh Tes</li>
            </ul>
            <h4>Ini Adalah Ujicoba Tes Ketelitian<br>Petunjuk Pengisian: <br>
...
<section class="section1">
    <div class="container clearfix">
        ...
        <div class="col-md-12" style="display:none" id="lembarsoal">
            ...
            <div class="row">
            <form id="contohketelitianform" action="" method="post">
                <div class="col-md-6">
                    <table class="table table-striped checkout effect-fade in" data-effect="fade" style="transition: all 0.7s ease-in-out 0s;">
                        ...
                        <tbody>
                            ...
                            <tr style="height: 100px;">
                                <td><?= $i?></td>
                                <td>
                                    <img src="<?= base_url('assets/tesketelitian/soal/contohsoal'.$i.'.png')?>" width="170" style="margin-top: 10px;"/>
                                </td>
                                <td>
                                    <div class="radio">
                                        <label><input type="radio" name="soal<?= $i?>" value="a"><img src="<?= base_url('assets/tesketelitian/jawaban/contohjawaban'.$i.'a.png')?>" width="30"/></label>
                                        <label><input type="radio" name="soal<?= $i?>" value="b"><img src="<?= base_url('assets/tesketelitian/jawaban/contohjawaban'.$i.'b.png')?>" width="30"/></label>
                                        <label><input type="radio" name="soal<?= $i?>" value="c"><img src="<?= base_url('assets/tesketelitian/jawaban/contohjawaban'.$i.'c.png')?>" width="30"/></label>
                                        <label><input type="radio" name="soal<?= $i?>" value="d"><img src="<?= base_url('assets/tesketelitian/jawaban/contohjawaban'.$i.'d.png')?>" width="30"/></label>
                                        <label><input type="radio" name="soal<?= $i?>" value="e"><img src="<?= base_url('assets/tesketelitian/jawaban/contohjawaban'.$i.'e.png')?>" width="30"/></label>
                                    </div>
                                </td>
                            </tr>
                            <?php }?>
