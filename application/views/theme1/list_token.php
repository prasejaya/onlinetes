...
<div id="customModal" class="modal fade" role="dialog">
    <div class="modal-dialog">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <?= $this->formbuilder->open_form(array('id'=>'formcustom','action' => $page_post, 'class' => 'form-horizontal', 'method' => 'post', 'target'=>isset($page_typetarget)?$page_typetarget:'')); ?>
                    <?php //print_r($datavalue); ?>
                    <?= $this->formbuilder->build_form_horizontal($formdata, $datavalue); ?>
                    <?= $this->formbuilder->close_form(); ?>
            </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="$('#formcustom').submit()">Generate</button>
                <button type="button" class="btn btn-success" data-dismiss="modal">batal</button>
            </div>
        </div>
...
<?php }?>
        ...
        <!-- Row -->
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <?php if(isset($page_post)&&$page_post!=''&&$akses_insert){?>
                    
                    <button onclick="$('#customModal').modal('show');" type="button" class="btn btn-success btn-md pull-right"><i class="fa fa-plus"></i> <?= (isset($nama_tomboltambah)? $nama_tomboltambah:'Tambah')?></button>
