<?php 
$seting=$this->m_seting->get_one('id_seting, namasekolah, namasingkat, alamat, email, telp, jenjang, logo', 1);      
?>
<!DOCTYPE html>
<html lang="en">
    <head>
        ...
        <link rel="icon" type="image/png" href="<?= base_url('uploads/images/').$seting['logo']?>" />
        ...
        <title>SisCloud - <?= $seting['namasingkat']?></title>
    </head>
