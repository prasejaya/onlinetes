...
<!--export--->
<script src="<?= base_url() ?>asset/plugins/DataTables/buttons.flash.min.js" type="text/javascript"></script>
<script src="<?= base_url() ?>asset/plugins/DataTables/jszip.min.js" type="text/javascript"></script>
<script src="<?= base_url() ?>asset/plugins/DataTables/pdfmake.min.js" type="text/javascript"></script>
<script src="<?= base_url() ?>asset/plugins/DataTables/vfs_fonts.js" type="text/javascript"></script>
<script src="<?= base_url() ?>asset/plugins/DataTables/buttons.html5.min.js" type="text/javascript"></script>
<script src="<?= base_url() ?>asset/plugins/DataTables/buttons.print.min.js" type="text/javascript"></script>
